    ...
    <div class="centered-container">
      <div class="row justify-center items-center" style="height: 100vh ">
        <div class="col-12 col-md-15" style="text-align: center;">
          <q-card v-bind:style="$q.screen.lt.sm ? {'width': '100%'} : {'width': '130%'}">
            <q-card-section>
              <q-avatar size="150px">
            ...
            <q-card-section>
              <q-form class="q-gutter-md" @submit.prevent="openTermsModal">
...
export default {
  ...
  methods: {
    ...mapActions('auth', ['doRegistration']),
    openTermsModal() {
      this.showTermsModal = true;
    },
    acceptTerms() {
      // Adicione aqui a lógica para aceitar os Termos e Condições
      this.addUser();
      this.showTermsModal = false;
    },
    rejectTerms() {
      // Adicione aqui a lógica para recusar os Termos e Condições
      this.showTermsModal = false;
    },
    addUser () {
      if (
      ...
      axios
        .post('http://localhost:3001/api/users', this.registration)
        .then((response) => {
          this.$q.notify({
            type: 'positive',
    ...
    cancelAddUser () {
      this.registration = { username: '', name: '', email: '', password: '' }
    }
  }
}
</script>
