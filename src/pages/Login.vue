 ...
 <div class="centered-container" >
  <div class="row justify-center items-center" style="height: 100vh " >
    <div class="col-12 col-md-15" style="text-align: center;">
      <q-card v-bind:style="$q.screen.lt.sm ? {'width': '200%'} : {'width': '115%'}">
        <q-card-section>
          <q-avatar size="150px" >
        ...
        <q-card-section>
          <q-form class="q-gutter-md" @submit.prevent="submitForm">
            ...
            <div>
              ...
              <q-btn class="full-width q-mt-md" color="grey-8" label="Entrar como anônimo" to="/AnonimoLayout" @click="loginAnonimo" rounded></q-btn>
