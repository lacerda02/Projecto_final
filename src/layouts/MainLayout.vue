      ...
      >
        <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
          <q-list padding>
            ...
            <q-item
            to="/EmergencyReports" clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="warning" />
              </q-item-section>
            ...
            <q-item
            to="/EducationESensitivity" clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="book" />
              </q-item-section>
            ...
            <q-item
            to="/UserConfiguration" clickable v-ripple>
              <q-item-section avatar>
            ...
            <q-item
            to="/FeedbackImprovements" clickable v-ripple>
              <q-item-section avatar>
